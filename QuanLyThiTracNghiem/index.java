...
public class index {
    ...
    public void xemCauHoiHocPhan(String maHocPhan) {
        ...
        System.out.println("Danh sach cau hoi hoc phan  " + HocPhan.at(HocPhan.timKiem(maHocPhan)).getTenHocPhan());
        for (int i = 0; i < chuong.soLuong(); i++) {
            danhSachNhomCauHoi nhomcauhoi = NhomCauHoi.timKiemTheoChuong(chuong.at(i).getMaChuong());
            System.out.printf("Chuong %d:\n %s :\n", i + 1, chuong.at(i).getNoiDung());
    ...
    public void quanLyHocPhan() {
        while (true) {
            ...
            System.out.println("|    4.Xem Tat Ca Hoc Phan     |");
            System.out.println("|    5.Thoat                   |");
            System.out.println("--------------------------------");
            System.out.println("Nhap lua chon cua ban:");
            int luachon = nhap.kiemTraSo(1, 5);
